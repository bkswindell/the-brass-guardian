...
## 1. [The Guild](The_Mechanists_Guild.md) of Framewrights
...
Serious, conservative, exacting, and proud of work designed to outlast its builders.

### Symbol

A brass keystone crossed by two structural beams.

### Common Saying

> Everything rests somewhere.

## 2. [The Guild](The_Mechanists_Guild.md) of Enginewrights
...
Practical, direct, skeptical of mystical explanations, and deeply respectful of pressure.

### Symbol

A piston enclosed within a toothed wheel.

### Common Saying

> Pressure reveals weakness.

## 3. [The Guild](The_Mechanists_Guild.md) of Aetherwrights
...
Prestigious, secretive, analytical, and increasingly uneasy about what their own measurements imply.

### Symbol

A radiant crystal enclosed by three brass coils.

### Common Saying

> Power must have a path.

## 4. [The Guild](The_Mechanists_Guild.md) of Canalwrights
...
Patient, adaptable, observant, and more willing than most guilds to admit that hidden routes exist.

### Symbol

A lock gate above a turning waterwheel.

### Common Saying

> Water remembers the way.

## 5. [The Guild](The_Mechanists_Guild.md) of Skywrights
...
Ambitious, innovative, proud, and frequently at odds with mariners who distrust laboratory certainty.

### Symbol

A winged anchor beneath a lift cell.

### Common Saying

> Build for the storm you have not seen.

## 6. [The Guild](The_Mechanists_Guild.md) of Clockwrights

### Stewardship

Public clocks, navigation chronometers, timing relays, civic synchronization, factory time systems, astronomical instruments, and calendar conversion.
...
Precise, respected, cautious, and quietly frightened by contradictions in their own archives.

### Symbol

An escapement wheel beneath an eight-pointed star.

### Common Saying

> Agreement makes the hour.

## 7. [The Guild](The_Mechanists_Guild.md) of Artificers
...
Inventive, exacting, ethically divided, and fascinated by the boundary between mechanism and personhood.

### Symbol

An articulated hand holding a small gear.

### Common Saying

> Precision is a promise.

## 8. [The Guild](The_Mechanists_Guild.md) of Verdant Mechanists
...
Patient, eccentric, interdisciplinary, and suspicious of anyone who insists life and machinery must remain separate.

### Symbol

A leaf growing through an open gear.

### Common Saying

> Life does not follow the blueprint.

## Political Balance

The eight guilds do not possess equal influence.
...
- common safety law,
- cross-guild dispute resolution,
- rank recognition,
- and unified political representation.
...
The guilds determine whether someone is trusted to practice that knowledge in the functioning city.
...
What the missing discipline represented remains unresolved.
