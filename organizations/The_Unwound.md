...
The Unwound is a broad reform movement united by one belief:
...
Most Unwound members are artisans, workers, engineers, gardeners, canal keepers, teachers, and families who believe machines should remain comprehensible, repairable, interruptible, and accountable to the people who use them.
...
The name **Unwound** does not originally mean broken.
...
- and fewer citizens capable of maintaining ordinary life without aetheric power.

To unwind the city is, in their language, to restore choice.

Their core principles include:

1. No essential civic system should depend on a mechanism no living person can stop.
2. Every neighborhood should retain manual water, heat, communication, and evacuation methods.
3. A citizen should be able to understand the machine that governs their work or home.
4. Public records should not depend on one official calendar or synchronized clock network.
...
They favor human craftsmanship, natural power, and mechanisms whose purpose remains visible. Some are suspicious of all aetheric technology, but most are not opposed to invention itself.
...
The Unwound symbol is an open spiral spring surrounding a small empty center.

It is often drawn as:

- chalk graffiti,
- a stamped brass token,
- a missing tooth in a gear emblem,
- or a [coil](The_Severed_Coil.md) deliberately left unfastened.

Its meaning is:

> A machine should always contain a way to release its tension.

Members sometimes carry **free clocks**—personal mechanical timepieces deliberately kept outside the civic synchronization system.

Free clocks are not corrected after Lost Seconds.
...
They do not yet understand temporal fluidity, but they have preserved evidence of it.

## Internal Structure

The Unwound has no single recognized leader.
...
[The Watch](The_Brass_Watch.md) sees:

- illegal gatherings,
- tampered conduits,
- hidden workshops,
- unsynchronized clocks,
- obstruction of official inspections,
- and a movement whose symbols appear near sabotage sites.
...
Neither side publicly admits this cooperation.

### Operational Conflict

[The Watch](The_Brass_Watch.md) and the Unwound frequently collide over:

- Golden Vein access tunnels,
- seized records,
- emergency power stations,
- detained activists,
- Council exclusion zones,
- and evidence from temporal incidents.

During major outages, Watch officers may depend on Unwound manual systems to evacuate or shelter civilians.

During investigations, Unwound communities may refuse cooperation unless [Thorne](../characters/Chief_Inspector_Beatrice_Thorne.md) guarantees that evidence will not be transferred to [the Council](The_High_Council_of_Aetherhaven.md) or Engine Complex.

### Clockwork Sentinels

The Unwound distrusts clockwork sentinels because their deepest command hierarchies are not understood.
...
- He repairs rather than merely replaces.
- He acknowledges that ancient technology is poorly understood.
- He has opposed Council secrecy.
- He treats machines as things that must be questioned.
- He has repeatedly risked himself to protect ordinary citizens.
...
They oppose attempts by [the Council](The_High_Council_of_Aetherhaven.md), Academy, Watch, or radicals to use her merely as a key.
...
- a useful political enemy,
- a source of embarrassing evidence,
- a pressure valve for worker anger,
- or a movement that may be correct about the city's dependence.
...
Others are intended to prevent questions.
...
- safety reports,
- and evidence that Golden Veins carry more than power.
...
sometimes preserve chronology that official systems lose.

Their records reveal:

- missing seconds accumulating unevenly,
- dates shifting between copied documents,
- anniversaries moving by a day,
...
- lost seconds,
- emotional resonance,
- or contradictions between competing chronologies.
...
The Unwound should not share one uniform.

Recurring visual elements may include:

- work clothes repaired rather than replaced,
- open-spring symbols,
- gears with one tooth deliberately removed,
- hand-cranked lamps,
- unsynchronized pocket watches,
- natural fibers alongside brass tools,
- visible manual mechanisms,
- chalk marks near meeting places,
- and broadsides printed in dark ink on inexpensive paper.
...
- blackened coils,
- split gear symbols,
- and red thread tied around broken mechanisms.

## Story Opportunities

### The Night the Heart Stopped

A citywide outage disables aether systems. Unwound workshops keep several districts alive with manual pumps, hand-cranked lights, and old heating systems.

### The Severed Vein

A radical cell cuts a Golden Vein and discovers that something other than energy is moving through it.
...
One neighborhood disconnects from the Golden Veins. For the first time in generations, its residents dream the same dream.
