...
public_projection:
  ...
  summary: The Inner Compass has a restricted Archive reference. Identity, purpose, and fuller context remain sealed or withheld.
...
A name associated with the concealed or senior leadership of [the Society of Explorers](The_Society_of_Explorers.md). The supplied source does not establish its membership, authority, or current activity.
