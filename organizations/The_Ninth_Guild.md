...
The Guild has no confirmed central headquarters.
...
Ancient mechanisms the Guild believes are already alive—or capable of becoming alive.

The Guild's experiments are intimate, singular, and unsettling.
...
Because the Guild refuses to discard contradictory evidence, its illegal archive may preserve truths lost by the official Archives.
...
The Guild is especially difficult to investigate because its crimes corrupt evidence.
...
Others actively help the Watch hunt Guild experiments.

## Relationship with [the Severed Coil](The_Severed_Coil.md)
