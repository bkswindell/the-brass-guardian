---
character_id: AH-CHAR-PLACEHOLDER-017
name: The First Tender
title: Administrative leader of the Conservancy
aliases:
  - First Tender
...
The unassigned administrative leader of [the Conservancy of Living Mechanisms](../organizations/The_Conservancy_of_Living_Mechanisms.md). The office coordinates the Conservancy but is distinct from [Juniper Bell](Juniper_Bell.md)'s older title as Keeper of [the Clockwork Gardens](../locations/The_Clockwork_Gardens.md).

## Source Notes

- The identity remains deliberately unassigned.
