...
Chancellor of [the Academy of Invention](../organizations/The_Academy_of_Invention.md) and one of [Aetherhaven](../locations/Aetherhaven.md)'s most brilliant scholars. She becomes [Amelia](Amelia_Hawthorne.md)'s informal mentor, discovered Prototype II in [the Hall of Unfinished Ideas](../locations/The_Hall_of_Unfinished_Ideas.md), and removed its original records because another party had begun searching for them.
