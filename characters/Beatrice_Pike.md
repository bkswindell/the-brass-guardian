---
character_id: AH-CHAR-PLACEHOLDER-019
name: Beatrice Pike
...
A Pike family name visible on the canonical plate for [Tamsin Pike's brass key](../artifacts/021_Tamsin_Pikes_Brass_Key.md). No further biography is established by the supplied source.
