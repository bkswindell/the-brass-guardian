...
- A character whose private guilt can conflict with good judgment.

## Personality and Methods

Mara is direct, observant, disciplined, and difficult to intimidate. She dislikes ceremony, theatrical authority, and explanations unsupported by evidence.
...
> I will not help you harm my city. I may help you survive it.

### Strengths

- Exceptional command judgment.
- Strong memory for vessels, crews, routes, and dock behavior.
- Political independence.
- Loyalty under pressure.
- Ability to remain calm during mechanical or temporal anomalies.
- Deep practical knowledge of airships and aetheric navigation.

### Vulnerabilities

- Carries responsibility long after it stops being useful.
- Believes a different choice might have saved the *Resolute's* crew.
- Withholds information when she fears others will repeat her mistakes.
...
- Record vessel arrivals.
- Inspect small mechanisms.
...
[Octavia](Chancellor_Octavia_Vale.md) sometimes provides Mara with classified information because she knows Mara will act decisively. Mara sometimes withholds information from [Octavia](Chancellor_Octavia_Vale.md) because she suspects the Council's records may adjust—or may already have been altered.
...
She does not know whether he is:

- temporally displaced,
- protecting someone,
- waiting to prevent an event,
...
The *Resolute* disappeared for seven months and returned with Mara as its only remaining passenger. Every clock aboard ran backward.

### Mara's Account

Only nineteen days passed aboard the vessel.

Mara was not a passenger. She was the captain.

Older copies of the official report identify her correctly. Newer copies sometimes change the wording.

### Contradictory Evidence

- Mara's crew manifest contains eleven names.
- The public register contains six.
- A sealed Council copy reportedly contains none.
- Some personal details of the missing crew are becoming difficult for Mara to remember.
- Mara rewrites the crew names every morning to preserve them.

### What Mara Will Admit

- The *Resolute* entered a region where stars appeared beneath the vessel.
- Instruments displayed arrivals for ports the ship had never visited.
- Docking bells sounded with no land in sight.
- A second *Resolute* appeared ahead, damaged and traveling in the opposite direction.
- The other vessel signaled: **DO NOT FOLLOW US HOME.**

### What Mara Will Not Admit

She saw an older version of herself standing on the other vessel's bridge.

The other Mara was not alone.
...
- Official records can adjust.
- Physical artifacts may retain previous chronologies.
- Identity and job titles can shift in archived language.
- Different timekeeping systems produce contradictory but authentic dates.
...
- Renovation plans redraw themselves around the empty space.
...
Mara maintains two sets of dock records.

The official ledger contains normal arrivals, cargo, inspections, and departures.

The black ledger records events the official systems cannot reliably preserve:

- Unregistered vessels.
- Ships arriving before departure.
- Passengers absent from manifests.
- Cargo changing while under guard.
- Mooring lights activating without approaching craft.
- Names disappearing from records.
- Chronometers disagreeing after Lost Seconds.

The first entry predates Mara's appointment.

It is written in her handwriting:

> MORNINGSTAR — BERTH RESERVED. DO NOT REASSIGN.

Mara does not remember writing it.

## Personal Artifacts

### The Backward Chronometer
...
A silver whistle that produces no sound near major temporal disturbances.

Mara uses it to test suspicious cargo and vessels.

### The Black Ledger

A private record designed to preserve events the Archives may later alter.

### The Resolute Nameplate

Mounted behind Mara's desk.

On some mornings it reads **RESOLUTE**.

On others it reads **MORNINGSTAR**.

Mara has never allowed anyone else to see it change.

## Visual Continuity

Mara should appear practical, weathered, and authoritative rather than theatrical.

Persistent visual elements:

- Woman in her forties or early fifties.
- Long navy, charcoal, or weather-darkened captain's coat.
- Brass fasteners and reinforced shoulders.
- Practical boots and working gloves.
- Flight goggles usually worn around her neck.
- Harbormaster's chain of office used only for formal duties.
- Dark hair with a silver streak associated with the *Resolute's* final voyage.
- Backward chronometer attached to her belt or kept close at hand.
- Clothing should show repair, salt, soot, and genuine use.
...
A young mechanic arrives claiming to have served aboard the *Resolute*. Mara recognizes the person immediately, but her surviving manifest contains only eleven names.

### The Ship That Returned Twice

Dockworkers report seeing the *Resolute* moored at an abandoned platform while the vessel remains sealed elsewhere.

### The Morningstar Hearing

[The High Council](../organizations/The_High_Council_of_Aetherhaven.md) orders the Passenger removed and the berth reassigned. Mara refuses, creating conflict among the Council, [Brass Watch](../organizations/The_Brass_Watch.md), [Aerial Mariners' Union](../organizations/The_Aerial_Mariners_Union.md), and Harbormaster's Office.
...
A distress signal arrives through obsolete dock equipment. The transmission is in Mara's voice and was sent during the vessel's disappearance:

> When the Morningstar arrives, do not let me aboard.

## Staged Revelations

### Safe for Early Volumes

- Mara commanded the *Resolute*.
- The ship disappeared for seven months.
...
- Crew manifests are actively changing.
- The ticket code matches symbols from the final voyage.
- The backward chronometer is counting toward the Morningstar.
- The *Resolute* encountered another version of itself.
- Mara saw an older version of herself.
- The nameplate changes between *Resolute* and *Morningstar*.
- A future Mara may warn the city not to let her board.
...
1. Why did the *Resolute* encounter another version of itself?
