...
No present profile should be treated as secretly assigning this role.
...
It should transform their meaning.
...
- whether kindness can be manipulated,
- whether every mentor has viewed her as a key,
- whether earlier victories were permitted,
- and whether her choices were ever truly her own.
...
- affection does not excuse harm,
- and she can confront someone she loves without becoming cruel.

Her eventual strength comes not from refusing to trust again, but from learning that trust must coexist with agency, evidence, and boundaries.

## Relationship with [Silas Rook](Silas_Rook_The_Stillmaker.md)
...
- operational genius,
- devoted believer,
- and possibly another person manipulated by someone he trusted.

This does not absolve him of violence.

It deepens the tragedy.
...
- and concealment of the true leader.

The movement's hierarchy is known only in fragments.
...
- or sacrifice operations he believes are essential.

## Candidate Selection Requirements

The identity should be selected later from an emotionally established character.
...
The choice must make earlier scenes deeper.

## Fair-Clue Design

Before the identity is selected, clues should remain modular and compatible with several candidates.
...
- what she fears,
- what motivates her,
- which people she will protect,
- and how strongly she resists being treated as a mechanism.

This knowledge allows them to anticipate her choices.
...
### Stage Three — [Silas](Silas_Rook_The_Stillmaker.md) Revealed
...
Evidence shows some Coil orders bypassed [Silas](Silas_Rook_The_Stillmaker.md) or predated his decisions.
...
The trusted character is revealed as the Hidden Architect.

The reveal should reframe multiple volumes.
