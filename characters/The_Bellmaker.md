...
An elderly artisan whom no one remembers meeting, though bells bearing his mark appear throughout [Aetherhaven](../locations/Aetherhaven.md). His bells ring for events rather than hours, and a tiny bell appeared in [Amelia](Amelia_Hawthorne.md)'s satchel after her first visit to [the Grand Atrium](../locations/The_Grand_Atrium.md).
