...
Lucian is a prominent public inventor and recurring professional rival whose exhibitions and personality draw attention throughout [Aetherhaven](../locations/Aetherhaven.md).

## Relationships

### [Professor Elias Hawthorne](Professor_Elias_Hawthorne.md)

Lucian considers [Elias](Professor_Elias_Hawthorne.md) outdated and competes with him professionally. The rivalry should not make Lucian casually malicious.

### [Amelia Hawthorne](Amelia_Hawthorne.md)

Lucian sees [Amelia](Amelia_Hawthorne.md) as both an engineering mystery and a rival. He must continue to recognize her as a person rather than merely a source of technology.

## Hidden History

The origin and purpose of the anonymous blueprints remain unresolved. Their possible connection to [the First Mechanist](The_First_Mechanist.md) is provisional.
...
- Do not confirm that their components form a [First Mechanist](The_First_Mechanist.md) device until canon explicitly connects those descriptions.

## Open Canon Questions

1. Who sent the anonymous blueprints?
2. What do the unexplained components form when combined?
3. Is the older [First Mechanist](The_First_Mechanist.md) machine the same developing mechanism?
4. What would make Lucian place truth or safety above public acclaim?
5. How does his rivalry with [Amelia](Amelia_Hawthorne.md) evolve into respect, hostility, or alliance?
