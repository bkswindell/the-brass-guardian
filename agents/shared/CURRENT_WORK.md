...
- Branch status: **MERGED / DELETE AFTER MAIN VERIFICATION**. `feat/world-entrance-map` has no unique work after the approved merge and should be deleted locally and remotely once pushed `main` and its production-safe deployment are verified.
