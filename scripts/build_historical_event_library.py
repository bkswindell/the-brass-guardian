...
def build_events() -> None:
    write("Historical_Event_Profile_Template.md", historical_template())
...
"""
    ...
    if project.exists():
        ...
        if "Historical_Event_Profile_Template.md" not in text:
            marker = "| [Story_Arc_Profile_Template.md](Story_Arc_Profile_Template.md) | Standard structure for story-arc records |\n"
            text = text.replace(marker, marker + "| [Historical_Event_Profile_Template.md](Historical_Event_Profile_Template.md) | Standard structure for objective in-world historical-event records |\n")
        section = """
## Historical Events
