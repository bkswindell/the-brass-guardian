...
OUTPUT = ROOT / "docs/development/CANON_DEVELOPMENT_TODO.md"
TODAY = "2026-08-02"
...
def global_tasks() -> list[Task]:
    return [
        Task("SYS-001", "P0", "READY", "Canon authority and contradiction policy", "docs/PROJECT_INDEX.md", "System", "For each expanded placeholder, explicitly record which PDF/DOCX details remain canonical, which are superseded, and which stay unresolved; never silently reconcile conflicts.", "Complete during every placeholder conversion."),
        Task("SYS-002", "P1", "READY", "Canonical visual integration standard", "docs/standards/CANON_MARKDOWN_STANDARD.md", "System", "Require every character, organization, location, story arc, and artifact record to embed its active canonical visuals with descriptive alt text and links to the authoritative image or artifact record.", "Apply during every visual task."),
        Task("SYS-003", "P2", "READY", "Location map-callout migration", "docs/standards/Map_Location_Reference_Style_Guide.md", "System", "Add a clear map callout to every location profile, including hidden or restricted-location handling where a public pin would be inappropriate.", "Complete alongside location visual tasks."),
        ...
        Task("SYS-005", "P6", "READY", "Accessibility and AI-ingestion review", "docs/standards/CANON_MARKDOWN_STANDARD.md", "System", "Review headings, YAML IDs, alt text, link labels, canon-status fields, TODO checkboxes, and visual descriptions for precise AI-agent ingestion and human accessibility.", "Run after each priority wave."),
        Task("SYS-006", "P6", "READY", "Broken-link and duplicate-canon audit", "docs/PROJECT_INDEX.md", "System", "Validate all relative Markdown links, ensure one authoritative owner for each canon fact, remove accidental duplicated summaries, and retain stable file paths when placeholders become completed profiles.", "Run after each priority wave."),
        Task("SYS-007", "P6", "READY", "Unused-art exclusion check", "docs/standards/CANON_MARKDOWN_STANDARD.md", "System", "Confirm no Markdown file, prompt, image reference, or generated asset uses material from `unused/` unless the project owner explicitly restores a named item.", "Continuous requirement."),
        Task("SYS-008", "P6", "READY", "Project index maintenance", "docs/PROJECT_INDEX.md", "System", "Update completed/placeholder/image counts, remove finished work from the active queue, and keep this TODO file synchronized after every merged canon or art batch.", "Continuous requirement."),
    ]
