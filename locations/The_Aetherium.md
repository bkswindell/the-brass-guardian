...
Canonical map reference: 1.

## Public Map Reference

At the center of [Aetherhaven](Aetherhaven.md) stands an enormous brass armillary surrounding a radiant sphere of condensed aether. Citizens call it the Heart Engine, and its rhythm changes are accompanied by every city clock losing exactly one second.
