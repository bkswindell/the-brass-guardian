...
Canonical map reference: D.

## Public Map Reference

Restricted Area D, an isolated observatory whose instruments, records, and silence distinguish it from the public [Observatory](The_Observatory.md).
