...
public_projection:
  ...
  summary: The Grand Atrium is catalogued as map reference 3 on the illustrated city chart. This stub preserves the mapped public name while a fuller source-grounded extract is prepared.
...
Canonical map reference: 3.

## Public Map Reference

A glass-domed conservatory containing tropical forests, rare flowers, indoor waterfalls, mechanical trees, and an orrery that tracks celestial bodies unknown to [Aetherhaven](Aetherhaven.md)'s astronomers.
