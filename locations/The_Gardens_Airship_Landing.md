...
No vessel by that name appears in any city registry.

The gardeners polish the plate anyway.
...
### [Brass Watch](../organizations/The_Brass_Watch.md)
...
A small storage cabinet contains:
...
No valid vessel registry, captain's roll, or commercial charter corresponds to the name.
...
A reinforced docking frame capable of receiving damaged or unstable vessels.

Its adjustable supports can hold:

- experimental hulls,
- broken gondolas,
- failing lift systems,
- and ships too dangerous to approach the crowded commercial port.

The cradle has saved many crews.

It has also received vessels whose damage did not match any known accident.

### The Courier House

A compact brass-and-glass station used by official messengers, aerial couriers, and diplomatic dispatch riders.

It contains:

- secure message lockers,
- pneumatic transfer tubes,
- weather notices,
- sealed document rooms,
- and a small waiting chamber.

Some messages arrive without a recorded courier.

### The Windglass Pavilion

An open observation shelter containing delicate instruments that display wind, pressure, aether current, and approaching weather.

Its suspended glass fins sing softly when conditions change.

Before certain temporal disturbances, they produce notes not included in the pavilion's tuning chart.
...
On rare nights, it answers the Storm Lantern Array at the commercial port with a sequence no current harbormaster recognizes.

## Relationship with the Wayfinder

The Landing is the *Wayfinder's* customary home berth within the city.

This makes it a recurring location for:
...
- [the Passenger](../characters/The_Passenger_of_Dock_Zero.md)'s belief that the *Morningstar* is expected,
...
Her private concern is that the berth may be necessary for something that has not arrived yet.

## Temporal and Anomalous Activity

The Landing is generally calm.

Its anomalies are subtle:

- guide lamps illuminating before an approach signal,
...
The arrival of an unknown vessel attracts attention quickly because nothing here is anonymous for long.

## Visual Continuity

The Gardens Airship Landing should consistently feature:

- an elevated stone-and-brass platform,
- water moving beneath and around it,
- garden terraces,
- flowering mechanical vines,
- luminous guide lamps,
- slim signal towers,
...
A damaged experimental vessel reaches the repair cradle carrying a passenger no manifest records.

### The Courier Without a Ship

A message is found inside the Courier House, though no courier has landed and the seal belongs to a distant region.

### The Wayfinder's Missing Hour

The *Wayfinder* returns from a short flight with one hour missing from its logs and fresh flowers growing inside the engine housing.
...
Dockworkers find both the Wayfinder and Morningstar berths under tension, as though two vessels are present—though only one can be seen.
...
1. Who created the Morningstar reservation?
