...
Canonical map reference: C.

## Public Map Reference

Restricted Area C, a deep subterranean region where sound, machinery, and distance behave unreliably and where official maps remain incomplete.
