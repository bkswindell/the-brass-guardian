---
schema_version: 1
id: AH-LOC-PLACEHOLDER-044
record_type: location
name: The Quiet Hangar
slug: the-quiet-hangar
aliases:
- Quiet Hangar
...
A restricted quarantine and evidence hangar at [the Aerial Docks](The_Aerial_Docks.md) where the Resolute is believed to remain sealed. Its clocks are isolated from the civic synchronization network.
