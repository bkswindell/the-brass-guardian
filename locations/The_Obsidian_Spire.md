...
public_projection:
  ...
  summary: 'Map annotation: “Off limits.” Further record sealed.'
...
Canonical map reference: A.

## Public Map Reference

Restricted Area A, a dark and heavily controlled spire whose origin, access systems, and present purpose remain unresolved.
