---
schema_version: 1
id: AH-LOC-PLACEHOLDER-005
record_type: location
name: The Clocktower Spire
slug: clocktower-spire
aliases:
- Clocktower Spire
...
- map_id: aetherhaven-city
  ...
  reference: '4'
public_projection:
  title: The Clocktower Spire
  summary: The Clocktower Spire is catalogued as map reference 4 on the illustrated city chart. This stub preserves the mapped public name while a fuller source-grounded extract is prepared.
...
Canonical map reference: 4.

## Public Map Reference

A towering civic clock containing thousands of visible gears and a great astronomical mechanism maintained by [the Keepers of Time](../organizations/The_Keepers_of_Time.md). Its deepest chamber contains a door that opens only when every clock in the city stops.
