...
- foreign botanicals,
- navigation charts,
- and cargo whose declared contents are sometimes more imaginative than accurate.

The port supports thousands of workers:
...
- damaged,
- under inspection,
- or capable of becoming an immediate hazard.
...
- and whether [the Watch](../organizations/The_Brass_Watch.md) may enter a vessel before [Mara](../characters/Captain_Mara_Voss.md) declares it safe.
...
The Crown is one of the first landmarks seen by arriving air travelers.

### Harbormaster's Tower

The administrative and operational center of the port.
...
A noisy commercial hall where shipping contracts, warehouse claims, insurance notes, labor assignments, salvage rights, and disputed manifests are bought, sold, or challenged.

A large mechanical board displays expected arrivals.

Occasionally, it lists vessels no clerk remembers entering.

### Hangar Row

A series of immense dirigible hangars used for repair, storage, quarantine, and private construction.

Some are brightly active around the clock.
...
No valid construction record identifies:

- who built it,
- which authority first controlled it,
- or why its number precedes the recognized dock system.

Its doors remain sealed.
...
A line of powerful elevated beacons used to guide vessels during fog, lightning, and aether storms.

The Array can project coded approach patterns visible from great distances.
...
A public and professional hall containing:
...
- memorial plaques,
- expedition notices,
- and charts of distant regions.

Children visit to watch mechanical globes display trade routes.
...
Only a small number of people are permitted inside.

Its clocks are not connected to the civic synchronization network.

## The Passenger of Dock Zero

[The Passenger](../characters/The_Passenger_of_Dock_Zero.md) is a recurring unidentified figure associated with the sealed hangar and the Morningstar mystery.
...
[The Passenger](../characters/The_Passenger_of_Dock_Zero.md)'s presence transforms Dock Zero from an architectural curiosity into an active unresolved case.
...
- obsolete transit codes,
- beacon frequencies,
- berth-control notation,
- and markings associated with the Morningstar Company.
...
- a chronal alignment station,
- or one part of a larger docking system whose other end is the Gardens' reserved berth.

This theory is not public canon and should remain unconfirmed in early stories.

## The Resolute Connection

The Aerial Docks are inseparable from the final voyage of the *Resolute*.
...
Airship travel naturally exposes the docks to conflicting calendars, navigation systems, and timekeeping methods.

This makes temporal discrepancies easier to dismiss as clerical or foreign-system errors.

Known irregularities include:

- arrivals logged before departure,
- passengers carrying obsolete date systems,
- cargo aging differently from its manifest,
- route clocks disagreeing with civic clocks,
- ships remembered by crews but absent from registries,
- and departure boards listing unknown vessels.
...
The docks are energetic, loud, multilingual, and constantly changing.
...
- weather sense,
- crew loyalty,
- and respect for the dangers of flight.

Dockworkers trade rumors as actively as cargo.
...
The Aerial Docks should consistently feature:

- towering brass-and-steel mooring spires,
- enormous airships and smaller courier craft,
...
- customs platforms,
- vast ribbed hangars,
- steam and cloud drifting through elevated structures,
- route boards,
- flags and pennants from distant places,
- and workers moving across multiple vertical levels.
...
A commercial vessel lands with thirty passengers and a manifest listing twenty-nine.

Everyone aboard agrees the count is correct.
...
A damaged vessel requests emergency landing from a city absent from every map.
...
- [The Passenger](../characters/The_Passenger_of_Dock_Zero.md) waits there.
...
- [The Passenger](../characters/The_Passenger_of_Dock_Zero.md) remains associated with Dock Zero and the Morningstar mystery.
