...
public_projection:
  ...
  summary: The Observatory is catalogued as map reference 23 on the illustrated city chart. This stub preserves the mapped public name while a fuller source-grounded extract is prepared.
...
Canonical map reference: 23.

## Public Map Reference

A public astronomical observatory studying [Aetherhaven](Aetherhaven.md)'s skies, distant bodies, and unusual celestial events from the city's upper reaches.
