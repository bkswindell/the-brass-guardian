---
schema_version: 1
id: AH-LOC-PLACEHOLDER-007
record_type: location
name: The Reflection Canals
slug: reflection-canals
aliases:
- Reflection Canals
...
- map_id: aetherhaven-city
  ...
  reference: '6'
public_projection:
  title: The Reflection Canals
  summary: The Reflection Canals is catalogued as map reference 6 on the illustrated city chart. This stub preserves the mapped public name while a fuller source-grounded extract is prepared.
...
Canonical map reference: 6.

## Public Map Reference

Mirror-like canals running through the inner city. Their waters sometimes reflect scenes, people, or skies that are not present above them.
