...
# [The Passenger](../characters/The_Passenger_of_Dock_Zero.md)’s Future-Dated Ticket
...
The visible passenger fragment must **not** be treated as proof that the ticket belongs to Elias Hawthorne. Current canon keeps [the passenger](../characters/The_Passenger_of_Dock_Zero.md) name damaged, blurred, and unverified. The apparent `Elias V...` text is recorded here only because it is physically visible in the generated image.

The plate’s recovery story at the Old Aetherhaven Customs House differs from the current story premise that [Mara](../characters/Captain_Mara_Voss.md) confiscated the ticket from [the Passenger](../characters/The_Passenger_of_Dock_Zero.md). The plate metadata may describe an earlier concept, a prior archival recovery, or an inconsistent record. The active character and location canon controls the story history until this discrepancy is explicitly reconciled.
