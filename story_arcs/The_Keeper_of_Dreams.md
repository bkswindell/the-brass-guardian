...
The main series later introduces [Juniper Bell](../characters/Juniper_Bell.md) as the eccentric Keeper of the Clockwork Gardens without immediately identifying her as the same figure.
...
- and a silver flower given to Amelia.
...
[Juniper](../characters/Juniper_Bell.md) appears as the public Keeper of the Clockwork Gardens.
...
Elias remembers the adventure differently from Amelia.
...
Amelia learns that emotional truth and physical evidence can coexist.

Elias learns not every mechanism can be understood by removing it from the experience that gives it meaning.
